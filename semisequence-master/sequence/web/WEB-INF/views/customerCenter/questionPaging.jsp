...
<body>
	<div class="pagingArea" align="center">
		<!-- 맨 앞으로 이동 버튼 -->
	    <button class="page" id="startPage"><<</button>
		...
		<c:if test="${ requestScope.selectCriteria.pageNo > 1 }">
			<button class="page" id="prevPage"><</button>
		</c:if>
		...
		<c:if test="${ requestScope.selectCriteria.pageNo < requestScope.selectCriteria.maxPage }">
			<button class="page" id="nextPage">></button>
		</c:if>
	...
	<script>
		...
		const link = "${ pageContext.servletContext.contextPath }/questionList";
