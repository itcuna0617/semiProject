...
<body>
	<jsp:include page="/WEB-INF/views/common/header.jsp"/>
     ...
     <section>		
     	<h1 style="text-align: center;"> 합격자 명단 </h1>
		<div class="header">
			<h1>총 ${ noticePaging.total }명의 합격자가 있습니다. </h1>
	     		...
	     		<c:if test="${ requestScope.criteria == '기업' }">
					<h1>${ requestScope.applicationList[0].entInfo.entName }에 합격한 지원자 전체 목록입니다.</h1>     			
	     		</c:if>
	...
	<br clear="both"/>
	<jsp:include page="/WEB-INF/views/application/passPaging.jsp"></jsp:include>
