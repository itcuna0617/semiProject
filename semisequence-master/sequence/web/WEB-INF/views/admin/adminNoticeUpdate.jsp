...
<body>
		...
		<form action="${ pageContext.servletContext.contextPath }/notice/update" method="post">
			...
			공지 사항 제목 : <input type="text" name="noticeTitle" maxlength="20" size="20" value="${ requestScope.notice.noticeTitle }"><br>
			...
			<button type="button" onclick="location.href='${ pageContext.servletContext.contextPath }/notice/list?page=1'">취소</button>
