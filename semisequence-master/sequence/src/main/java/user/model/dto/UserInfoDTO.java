...
public class UserInfoDTO {
	...
	public UserInfoDTO(int userNo, String userName, String userId, String userPassword, String userPhone,
			String userEmail, int userBalance, double userAvgScore, String userDropYn, String userSanctionYn,
			String userActiveYn, String userClassName) {
		this.userNo = userNo;
	...
	public String toString() {
		return "UserInfoDTO [userNo=" + userNo + ", userName=" + userName + ", userId=" + userId + ", userPassword="
				+ userPassword + ", userPhone=" + userPhone + ", userEmail=" + userEmail + ", userBalance="
				+ userBalance + ", userAvgScore=" + userAvgScore + ", userDropYn=" + userDropYn + ", userSanctionYn="
				+ userSanctionYn + ", userActiveYn=" + userActiveYn + ", userClassName=" + userClassName + "]";
	}
