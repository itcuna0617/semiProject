...
@WebServlet("/application/fail")
public class FailApplicationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = appService.failApplication(applicationNo);
		...
		if(result) {
			path="/WEB-INF/views/application/applicationFail.jsp";
