...
@WebServlet("/application/select/pass")
public class SelectApplicationPassByEnt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int total=appService.selectPassTotalCount(criteriaMap);
		NoticePagenation pagenation = new NoticePagenation(total, size, currentPage, pagingCount);
		
		List<ApplicationDTO> applicationList=appService.selectApplicationPass(criteriaMap);
		...
		path="/WEB-INF/views/posting/selectApplicationPassByEnt.jsp";
		if("posting".equals(criteria)) {
